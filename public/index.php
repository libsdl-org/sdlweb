...
//-------------------------------------------------------------------------------------------------
	...
	switch ($action) {
		...
		Simple DirectMedia Layer supports Linux, Windows, BeOS, MacOS Classic, Mac OS X, FreeBSD, OpenBSD, BSD/OS, Solaris, IRIX, and QNX. There is also code, but no official support, for Windows CE, AmigaOS, Dreamcast, Atari, NetBSD, AIX, OSF/Tru64, RISC OS, and SymbianOS.<p>
		SDL is written in C, but works with C++ natively, and has bindings to several other languages, including Ada, Eiffel, Java, Lua, ML, Pascal, Perl, PHP, Pike, Python, and Ruby. <br>
		</font>
		<!-- End Intro -->
