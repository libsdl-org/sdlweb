...
Tue Jan 13
  ...
  <p>Changes for Tue Mar 26: <br>
     <ul>
	<LI> 1.2.4: More Atari fixes from Patrice
     </ul>
  </p>
  <p>Changes for Sat Mar 23: <br>
     <ul>
  ...
  <p>Changes for Fri Oct 26: <br>
     <ul>
	<LI> 1.2.3: Fixed command line library install on MacOS X
     </ul>
  </p>
  <p>Changes for Wed Oct 24: <br>
     <ul>
  ...
  <p>Changes for Mon Oct 8: <br>
     <ul>
	<LI> 1.2.3: Added photon fixes submitted by Luca Barbato
     </ul>
  </p>
  <p>Changes for Sun Sep 30: <br>
     <ul>
