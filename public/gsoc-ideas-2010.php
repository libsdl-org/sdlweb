...
<br>
<li> General Development <br>
	SDL has an ambitious feature set in development and there are lots of areas where you can pitch in.  You can view the full SDL 1.3 development roadmap at <a href="http://wiki.libsdl.org/moin.cgi/Roadmap">http://wiki.libsdl.org/moin.cgi/Roadmap</a>
</li>
<br>
</ul>
...
<li> International Input <br>
	SDL 1.3 has a clean API for receiving Unicode character input, however only Mac OS X currently has Input Method Editor (IME) support implemented.  If you consider yourself an International Woman of Mystery, you might consider traveling to remote climes and helping them input exotic languages into games.  You could pick either Windows or XFree86 and see how to integrate their IME implementations into the SDL API.
</li>
<br>
</ul>
...
<h3> Video Ideas </h3>
<ul>
<li> Recording Support <br>
	This is a big ticket item.  There are lots of interesting applications for the ubiquitous webcam, including augmented reality and virtual reality systems.  The challenge to this is to provide a simple API that supports the myriad set of devices on various platforms.
</li>
<br>
<li> Video Support <br>
	This would involve adding a simple remote control type interface to native video playback solutions displaying in an SDL window.  One aspect of this is researching the different playback solutions and seeing if they can output to a texture or overlay managed by the SDL application.  Another aspect of this would involve investigating how audio synchronization would be handled.
</li>
<br>
