...
<html>
    ...
    <body>        
        <div id="wrapper">
            ...
            <div id="content">
               <h1>SDL version 2.0.0 (stable)</h1>
                <div class="col left">
...
-->
                        ...
                        <a href="release/SDL2-2.0.0.zip"
                           >SDL2-2.0.0.zip</a>
                        - <a href="release/SDL2-2.0.0.zip.sig">GPG signed</a><br>
                        <a href="release/SDL2-2.0.0.tar.gz"
                           >SDL2-2.0.0.tar.gz</a>
                        - <a href="release/SDL2-2.0.0.tar.gz.sig">GPG signed</a><br>
                    </blockquote>
                    ...
                    <blockquote>
                        <p><span class="title">
                            ...
                            <a href="release/SDL2-2.0.0-win32-x86.zip"
                               >SDL2-2.0.0-win32-x86.zip</a> (32-bit Windows)<br>
                            <a href="release/SDL2-2.0.0-win32-x64.zip"
                               >SDL2-2.0.0-win32-x64.zip</a> (64-bit Windows)<br>
                        </p>
                        <p><span class="title">
                                Mac OS X:
                            </span><br>
                            <a href="release/SDL2-2.0.0.dmg"
                               >SDL2-2.0.0.dmg</a> (Intel 10.5+)<br>
                        </p>
                        <p><span class="title">
                                Linux:
                            </span><br>
                    ...
                    <blockquote>
	                    <p><span class="title">
		                    ...
		                    <a href="release/SDL2-devel-2.0.0-VC.zip"
		                                    >SDL2-devel-2.0.0-VC.zip</a> (Visual C++ 32/64-bit)<br>
		                    <a href="release/SDL2-devel-2.0.0-mingw.tar.gz"
		                                    >SDL2-devel-2.0.0-mingw.tar.gz</a> (<a href="http://mingw-w64.sourceforge.net/">MinGW</a> 32/64-bit)<br>
	                    </p>
	                    <p><span class="title">
		                    Mac OS X:
		                    </span><br>
